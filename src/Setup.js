module.exports = MonkeySee => {
   ...
   */
  MonkeySee.prototype.initAndMaybeReadWASMBinary = function () {
   ...
   * Initializes BRFv4
   */
  MonkeySee.prototype.init = function () {
    this.injectBRFv4()
    this.injectDebugger()
    this.injectCursor()
  }
   ...
   */
  MonkeySee.prototype.injectBRFv4 = function () {
   ...
   */
  MonkeySee.prototype.startBRFv4 = function () {
   ...
   */
  MonkeySee.prototype.waitForSDK = function () {
   ...
   */
  MonkeySee.prototype.initSDK = function () {
